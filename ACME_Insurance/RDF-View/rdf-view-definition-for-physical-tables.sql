...
prefix ns3: <http://demo.openlinksw.com/acme-insurance-test#>
...
create IRI class <r2rml:virt02-33f5e8b734b5a34ee6e707e279a84917> "http://demo.openlinksw.com/acme-insurance/Policy-%ld#this" (in Policy_Identifier integer) .
...
from sqlquery (SELECT DISTINCT 
                                             ...
                                             WHERE agreement_party_role.party_role_code = 'AG') as tbl4
from "Demo"."acme"."catastrophe" as tbl5
from "Demo"."acme"."catastrophe" as tbl6
from sqlquery (SELECT 
                                             ...
                                             JOIN demo.acme.physical_location ON geographic_location.physical_location_identifier = physical_location.physical_location_identifier) as tbl7
from "Demo"."acme"."claim" as tbl8
from "Demo"."acme"."claim" as tbl9
from "Demo"."acme"."claim" as tbl10
from "Demo"."acme"."claim" as tbl11
from sqlquery (SELECT 
                                                geographic_location_identifier,
                                                line_1_address, 
                                                line_2_address, 
                                             ...
                                             FROM demo.acme.geographic_location 
                                             JOIN demo.acme.location_address ON geographic_location.location_address_identifier = location_address.location_address_identifier
                                             JOIN demo.acme.physical_location ON geographic_location.physical_location_identifier = physical_location.physical_location_identifier) as tbl12
from sqlquery (SELECT 
                                                ca.claim_identifier, 
                                                ca.claim_amount_identifier, 
                                                ca.claim_amount
                                             FROM demo.acme.claim_amount ca
                                             JOIN demo.acme.expense_payment ep ON ca.claim_amount_identifier = ep.claim_amount_identifier) as tbl13
from sqlquery (SELECT 
                                                ca.claim_identifier, 
                                                ca.claim_amount_identifier, 
                                                ca.claim_amount
                                             FROM demo.acme.claim_amount ca
                                             JOIN demo.acme.expense_reserve er ON ca.claim_amount_identifier = er.claim_amount_identifier) as tbl14
from "Demo"."acme"."insurable_object" as tbl15
from sqlquery (SELECT 
                                                geographic_location_identifier,
                                                line_1_address, 
                                                line_2_address, 
                                             ...
                                             FROM demo.acme.geographic_location 
                                             JOIN demo.acme.location_address ON geographic_location.location_address_identifier = location_address.location_address_identifier
                                             JOIN demo.acme.physical_location ON geographic_location.physical_location_identifier = physical_location.physical_location_identifier) as tbl16
from sqlquery (SELECT 
                                                geographic_location_identifier,
                                                line_1_address, 
                                                line_2_address, 
                                             ...
                                             FROM demo.acme.geographic_location 
                                             JOIN demo.acme.location_address ON geographic_location.location_address_identifier = location_address.location_address_identifier
                                             JOIN demo.acme.physical_location ON geographic_location.physical_location_identifier = physical_location.physical_location_identifier) as tbl17
from sqlquery (SELECT 
                                                geographic_location_identifier,
                                                line_1_address, 
                                                line_2_address, 
                                             ...
                                             FROM demo.acme.geographic_location 
                                             JOIN demo.acme.location_address ON geographic_location.location_address_identifier = location_address.location_address_identifier
                                             JOIN demo.acme.physical_location ON geographic_location.physical_location_identifier = physical_location.physical_location_identifier) as tbl18
from sqlquery (SELECT 
                                                ca.claim_identifier, 
                                                ca.claim_amount_identifier, 
                                                ca.claim_amount
                                             FROM demo.acme.claim_amount ca
                                             JOIN demo.acme.loss_payment lp ON ca.claim_amount_identifier = lp.claim_amount_identifier) as tbl19
from sqlquery (SELECT 
                                                ca.claim_identifier, 
                                                ca.claim_amount_identifier, 
                                                ca.claim_amount
                                             FROM demo.acme.claim_amount ca
                                             JOIN demo.acme.loss_reserve lr ON ca.claim_amount_identifier = lr.claim_amount_identifier) as tbl20
from sqlquery (SELECT 
                                                policy_amount_identifier, 
                                                policy_amount.policy_amount, 
                                                policy_amount.policy_coverage_detail_identifier
                                             FROM demo.acme.policy_amount 
                                             WHERE policy_amount_identifier not in (SELECT policy_amount_identifier FROM demo.acme.premium )) as tbl21
from sqlquery (SELECT 
                                                policy_amount_identifier, 
                                                policy_amount.policy_amount, 
                                                policy_amount.policy_coverage_detail_identifier
                                             FROM demo.acme.policy_amount 
                                             WHERE policy_amount_identifier not in (SELECT policy_amount_identifier FROM demo.acme.premium )) as tbl22
from "Demo"."acme"."policy_coverage_detail" as tbl23
from "Demo"."acme"."policy_coverage_detail" as tbl24
from "Demo"."acme"."policy_coverage_detail" as tbl25
from "Demo"."acme"."policy_coverage_detail" as tbl26
from "Demo"."acme"."policy" as tbl27
from "Demo"."acme"."policy" as tbl28
from sqlquery (SELECT DISTINCT 
                                                party_identifier 
                                             FROM demo.acme.agreement_party_role
                                             JOIN demo.acme.policy ON agreement_party_role.agreement_identifier = policy.policy_identifier 
                                             WHERE agreement_party_role.party_role_code = 'PH') as tbl29
from sqlquery (SELECT DISTINCT 
                                                party_identifier 
                                             FROM demo.acme.agreement_party_role
                                             JOIN demo.acme.policy ON agreement_party_role.agreement_identifier = policy.policy_identifier 
                                             WHERE agreement_party_role.party_role_code = 'PH') as tbl30
from "Demo"."acme"."policy" as tbl31
from "Demo"."acme"."policy" as tbl32
from sqlquery (SELECT 
                                                ...
                                                policy_amount.policy_coverage_detail_identifier
                                             FROM demo.acme.policy_amount 
                                             JOIN demo.acme.premium ON policy_amount.policy_amount_identifier = premium.policy_amount_identifier) as tbl33
from sqlquery (SELECT 
                                                policy_amount.policy_amount_identifier, 
                                                policy_amount.policy_amount, 
                                                policy_amount.amount_type_code , 
                                                ...
                                                policy_amount.policy_coverage_detail_identifier
                                             FROM demo.acme.policy_amount 
                                             JOIN demo.acme.premium ON policy_amount.policy_amount_identifier = premium.policy_amount_identifier) as tbl34
from sqlquery (SELECT 
                                                policy_amount.policy_amount_identifier, 
                                                policy_amount.policy_amount, 
                                                policy_amount.amount_type_code,  
                                             ...
                                             FROM demo.acme.policy_amount 
                                             JOIN demo.acme.premium ON policy_amount.policy_amount_identifier = premium.policy_amount_identifier) as tbl35
from sqlquery (SELECT 
                                                policy_amount.policy_amount_identifier, 
                                                policy_amount.policy_amount , 
                                                policy_amount.amount_type_code , 
                                                ...
                                                policy_amount.policy_coverage_detail_identifier
                                             FROM demo.acme.policy_amount 
                                             JOIN demo.acme.premium ON policy_amount.policy_amount_identifier = premium.policy_amount_identifier) as tbl36
from sqlquery (SELECT 
                                                geographic_location_identifier,
                                                line_1_address, 
                                                line_2_address, 
                                             ...
                                             FROM demo.acme.geographic_location 
                                             JOIN demo.acme.location_address ON geographic_location.location_address_identifier = location_address.location_address_identifier
                                             JOIN demo.acme.physical_location ON geographic_location.physical_location_identifier = physical_location.physical_location_identifier) as tbl37
from sqlquery (SELECT DISTINCT 
                                                party_identifier
                                             FROM demo.acme.assessment_party_role
                                             WHERE demo.acme.assessment_party_role.party_role_code = 'UW') as tbl38
from sqlquery (SELECT DISTINCT 
                                                party_identifier
                                             FROM demo.acme.assessment_party_role
                                             WHERE assessment_party_role.party_role_code = 'UW') as tbl39
from sqlquery (SELECT 
                                             ...
                                             JOIN demo.acme.assessment  ON ar.assessment_identifier = assessment.assessment_identifier) as tbl40
from sqlquery (SELECT 
                                                assessment.assessment_identifier, 
                                                assessment_description, 
                                                assessment.begin_date, 
                                             ...
                                             FROM demo.acme.assessment_result ar
                                             JOIN demo.acme.underwriting_assessment ua ON ar.assessment_result_identifier = ua.assessment_result_identifier
                                             JOIN demo.acme.assessment  ON ar.assessment_identifier = assessment.assessment_identifier) as tbl41
from sqlquery (SELECT 
                                                assessment.assessment_identifier, 
                                                assessment_description, 
                                                assessment.begin_date, 
                                             ...
                                             FROM demo.acme.assessment_result ar
                                             JOIN demo.acme.underwriting_assessment ua ON ar.assessment_result_identifier = ua.assessment_result_identifier
                                             JOIN demo.acme.assessment  ON ar.assessment_identifier = assessment.assessment_identifier) as tbl42
from sqlquery (SELECT 
                                                geographic_location_identifier,
                                                line_1_address, 
                                                line_2_address, 
                                             ...
                                             FROM demo.acme.geographic_location 
                                             JOIN demo.acme.location_address ON geographic_location.location_address_identifier = location_address.location_address_identifier
                                             JOIN demo.acme.physical_location ON geographic_location.physical_location_identifier = physical_location.physical_location_identifier) as tbl43
from "Demo"."acme"."claim_coverage" as tbl44
from sqlquery (SELECT 
                                                assessment.assessment_identifier, 
                                             ...
                                             WHERE assessment_party_role.party_role_code = 'UW') as tbl45
from sqlquery (SELECT 
                                             ...
                                             JOIN demo.acme.assessment ON assessment.assessment_identifier = agreement_assessment.assessment_identifier) as tbl46
from "Demo"."acme"."claim" as tbl47
from "Demo"."acme"."claim_coverage" as tbl48
from sqlquery (SELECT 
                                                ca.claim_identifier, 
                                                ca.claim_amount_identifier, 
                                                ca.claim_amount
                                             FROM demo.acme.claim_amount ca
                                             JOIN demo.acme.expense_payment ep ON ca.claim_amount_identifier = ep.claim_amount_identifier) as tbl49
from sqlquery (SELECT 
                                                ca.claim_identifier, 
                                                ca.claim_amount_identifier, 
                                                ca.claim_amount
                                             FROM demo.acme.claim_amount ca
                                             JOIN demo.acme.expense_reserve er ON ca.claim_amount_identifier = er.claim_amount_identifier) as tbl50
from "Demo"."acme"."policy_coverage_detail" as tbl51
from "Demo"."acme"."insurable_object" as tbl52
from sqlquery (SELECT 
                                                ca.claim_identifier, 
                                                ca.claim_amount_identifier, 
                                                ca.claim_amount
                                             FROM demo.acme.claim_amount ca
                                             JOIN demo.acme.loss_reserve lr ON ca.claim_amount_identifier = lr.claim_amount_identifier) as tbl53
from "Demo"."acme"."policy_coverage_detail" as tbl54
from sqlquery (SELECT 
                                                policy_amount_identifier, 
                                                policy_amount.policy_amount, 
                                                policy_amount.policy_coverage_detail_identifier
                                             FROM demo.acme.policy_amount 
                                             WHERE policy_amount_identifier not in (SELECT policy_amount_identifier FROM demo.acme.premium )) as tbl55
from "Demo"."acme"."policy_coverage_detail" as tbl56
from sqlquery (SELECT 
                                                policy.policy_identifier, 
                                                party_identifier
                                             FROM demo.acme.agreement_party_role
                                             JOIN demo.acme.policy ON agreement_party_role.agreement_identifier = policy.policy_identifier
                                             WHERE agreement_party_role.party_role_code = 'PH') as tbl57
from sqlquery (SELECT 
                                                policy_amount.policy_amount_identifier, 
                                                policy_amount.policy_amount, 
                                                policy_amount.amount_type_code , 
                                                ...
                                                policy_amount.policy_coverage_detail_identifier
                                             FROM demo.acme.policy_amount 
                                             JOIN demo.acme.premium ON policy_amount.policy_amount_identifier = premium.policy_amount_identifier) as tbl58
from "Demo"."acme"."claim" as tbl59
from sqlquery (SELECT 
                                                policy.policy_identifier, 
                                                party_identifier
                                             FROM demo.acme.agreement_party_role
                                             JOIN demo.acme.policy ON agreement_party_role.agreement_identifier = policy.policy_identifier
                                             WHERE agreement_party_role.party_role_code = 'AG') as tbl60
from sqlquery (SELECT 
                                                policy.policy_identifier, 
                                                assessment.assessment_identifier
                                             FROM demo.acme.agreement_assessment
                                             JOIN demo.acme.policy ON policy.policy_identifier = agreement_assessment.agreement_identifier
                                             JOIN demo.acme.assessment ON assessment.assessment_identifier = agreement_assessment.assessment_identifier) as tbl61
from sqlquery (SELECT 
                                                geographic_location_identifier,
                                                line_1_address, 
                                                line_2_address, 
                                             ...
                                             FROM demo.acme.geographic_location 
                                             JOIN demo.acme.location_address ON geographic_location.location_address_identifier = location_address.location_address_identifier
                                             JOIN demo.acme.physical_location ON geographic_location.physical_location_identifier = physical_location.physical_location_identifier) as tbl1
from sqlquery (SELECT 
                                                geographic_location_identifier,
                                                line_1_address, 
                                                line_2_address, 
                                             ...
                                             FROM demo.acme.geographic_location 
                                             JOIN demo.acme.location_address ON geographic_location.location_address_identifier = location_address.location_address_identifier
                                             JOIN demo.acme.physical_location ON geographic_location.physical_location_identifier = physical_location.physical_location_identifier) as tbl2
from sqlquery (SELECT 
                                                ca.claim_identifier, 
                                                ca.claim_amount_identifier, 
                                                ca.claim_amount
                                             FROM demo.acme.claim_amount ca
                                             JOIN demo.acme.loss_payment lp ON ca.claim_amount_identifier = lp.claim_amount_identifier) as tbl0
from sqlquery (SELECT DISTINCT 
                                                party_identifier
                                             FROM demo.acme.agreement_party_role
                                             JOIN demo.acme.policy ON agreement_party_role.agreement_identifier = policy.policy_identifier 
                                             WHERE agreement_party_role.party_role_code = 'AG') as tbl3
  {
    create ns1:9c4aafd744dd18ab9cfd93e579605ebe1c638834 as graph ns3: option (exclusive) {
            ...
            <r2rml:virt02-33f5e8b734b5a34ee6e707e279a84917> (tbl27."Policy_Identifier")
                    ns2:policyEffectiveDate tbl27."Effective_Date" .
            <r2rml:virt02-33f5e8b734b5a34ee6e707e279a84917> (tbl28."Policy_Identifier")
            ...
            <r2rml:virt02-cb03626721f8346a077f1bef25de43bc> (tbl30."Party_Identifier")
                    a ns2:PolicyHolder .
            <r2rml:virt02-33f5e8b734b5a34ee6e707e279a84917> (tbl31."Policy_Identifier")
                    a ns2:Policy ;
                    ns2:policyNumber tbl31."Policy_Number" .
            <r2rml:virt02-33f5e8b734b5a34ee6e707e279a84917> (tbl32."Policy_Identifier")
                    a ns2:Policy .
            ...
            <r2rml:virt02-33f5e8b734b5a34ee6e707e279a84917> (tbl46."Policy_Identifier")
            ...
            <r2rml:virt02-33f5e8b734b5a34ee6e707e279a84917> (tbl57."Policy_Identifier")
            ...
            <r2rml:virt02-33f5e8b734b5a34ee6e707e279a84917> (tbl60."Policy_Identifier")
            ...
            <r2rml:virt02-a2da0b0bdbe28838dc580b80140b58c5> (tbl61."Assessment_Identifier")
                    ns2:underwritesPolicy <r2rml:virt02-33f5e8b734b5a34ee6e707e279a84917> (tbl61."Policy_Identifier") }
  }
